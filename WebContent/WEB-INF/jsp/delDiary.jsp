...
<div class="container">
	<div class="row mt-5">
		...
		<div id="accordion">
			...
			<button class="float-right mx-0 col-md-6 btn btn-neutral btn-lg border border-danger" type="button" id="delbtn"  data-toggle="modal" data-target="#myModal">削除</button>
			</div>
